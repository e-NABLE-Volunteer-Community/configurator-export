...
import { ExportPackagingService } from './export-packaging.service';
...
describe('ExportOutputService', () => {
  let exportOutputService: ExportPackagingService;
  ...
  const init = async () => {
    ...
    exportOutputService = new ExportPackagingService(configService);
  };
