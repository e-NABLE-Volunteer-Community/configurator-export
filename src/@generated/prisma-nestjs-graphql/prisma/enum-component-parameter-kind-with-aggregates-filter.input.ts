...
import { NestedEnumComponentParameterKindWithAggregatesFilter } from './nested-enum-component-parameter-kind-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumComponentParameterKindFilter } from './nested-enum-component-parameter-kind-filter.input';

@InputType()
export class EnumComponentParameterKindWithAggregatesFilter {
