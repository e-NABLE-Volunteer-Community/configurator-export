...
import { NestedEnumMeasurementDescriptionKindWithAggregatesFilter } from './nested-enum-measurement-description-kind-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumMeasurementDescriptionKindFilter } from './nested-enum-measurement-description-kind-filter.input';

@InputType()
export class EnumMeasurementDescriptionKindWithAggregatesFilter {
